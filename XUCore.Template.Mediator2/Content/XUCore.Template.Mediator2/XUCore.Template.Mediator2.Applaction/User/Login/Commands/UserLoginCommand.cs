...
public class UserLoginCommand : Command<Result<LoginTokenDto>>, IDynamicWebApi
{
    /// <summary>
    /// 登录账号
    /// </summary>
    ...
    /// <returns></returns>
    [AllowAnonymous]
    public async Task<Result<LoginTokenDto>> PostAsync([FromServices] IMediator mediator, [Required][FromBody] UserLoginCommand request, CancellationToken cancellationToken)
