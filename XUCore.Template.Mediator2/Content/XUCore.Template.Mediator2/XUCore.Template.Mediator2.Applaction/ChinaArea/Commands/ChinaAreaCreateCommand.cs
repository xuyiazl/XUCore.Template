...
public class ChinaAreaCreateCommand : Command<Result<long>>, IMapFrom<ChinaAreaEntity>, IDynamicWebApi
{
    /// <summary>
    /// 上级区域Id
    /// </summary>
    ...
    /// <returns></returns>
    public async Task<Result<long>> CreateAsync([FromServices] IMediator mediator, [Required][FromBody] ChinaAreaCreateCommand request, CancellationToken cancellationToken = default)
