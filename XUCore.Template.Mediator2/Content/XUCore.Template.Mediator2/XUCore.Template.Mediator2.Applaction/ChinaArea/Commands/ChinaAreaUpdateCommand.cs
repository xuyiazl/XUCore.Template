...
public class ChinaAreaUpdateCommand : Command<Result<int>>, IMapFrom<ChinaAreaEntity>, IDynamicWebApi
{
    /// <summary>
    /// id
    /// </summary>
    ...
    /// <returns></returns>
    public async Task<Result<int>> UpdateAsync([FromServices] IMediator mediator, [Required][FromBody] ChinaAreaUpdateCommand request, CancellationToken cancellationToken = default)
