...
namespace XUCore.Template.EasyFreeSql.Applaction.User.User
{
    ...
    public interface IUserAppService : IScoped
    {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<Result<List<long>>> GetRelevanceRoleKeysAsync(long userId, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<Result<List<UserLoginRecordDto>>> GetRecordListAsync(UserLoginRecordQueryCommand request, CancellationToken cancellationToken = default);
        /// <summary>
        /// 获取所有登录记录分页
        /// </summary>
        /// <param name="request"></param>
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<Result<PagedModel<UserLoginRecordDto>>> GetRecordPageAsync(UserLoginRecordQueryPagedCommand request, CancellationToken cancellationToken = default);
