...
namespace XUCore.Template.EasyFreeSql.Applaction.User.Menu
{
    ...
    public interface IMenuAppService : IAppService
    {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<Result<List<MenuTreeDto>>> GetTreeAsync(CancellationToken cancellationToken = default);
        /// <summary>
        /// 获取导航列表
        /// </summary>
        /// <param name="request"></param>
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<Result<List<MenuDto>>> GetListAsync(MenuQueryCommand request, CancellationToken cancellationToken = default);
        /// <summary>
        /// 获取分页
        /// </summary>
        /// <param name="request"></param>
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<PagedModel<MenuDto>> GetPageAsync(MenuQueryPagedCommand request, CancellationToken cancellationToken);
    }
}
