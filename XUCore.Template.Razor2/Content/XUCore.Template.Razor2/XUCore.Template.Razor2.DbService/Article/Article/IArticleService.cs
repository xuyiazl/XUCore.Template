...
{
    public interface IArticleService : ICurdService<long, ArticleEntity, ArticleDto, ArticleCreateCommand, ArticleUpdateCommand, ArticleQueryCommand, ArticleQueryPagedCommand>, IScoped
    {
        /// <summary>
        /// 更新部分字段
        /// </summary>
