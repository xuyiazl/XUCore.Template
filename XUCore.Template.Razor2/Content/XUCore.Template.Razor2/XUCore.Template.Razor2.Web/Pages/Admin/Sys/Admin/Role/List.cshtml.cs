...
using XUCore.Template.Razor2.DbService.Auth.Role;

namespace XUCore.Template.Razor2.Web.Pages.Admin.Sys.Admin.Role
{
    [Authorize]
    ...
    public class ListModel : PageModel
    {
        ...
        {
            var res = await roleAppService.UpdateAsync(id, field, value);
        ...
        public async Task<IActionResult> OnPutBatchStatusAsync([FromForm] long[] ids, [FromForm] Status status)
        {
            ...
            var res = await roleAppService.UpdateAsync(ids, status);
