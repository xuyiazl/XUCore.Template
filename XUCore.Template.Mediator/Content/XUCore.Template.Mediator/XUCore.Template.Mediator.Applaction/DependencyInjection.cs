using XUCore.Template.Mediator.Applaction.Filters;
        ...
        if (serviceMode == "api")
        {
            ...
            services
                ...
                .AddFluentValidation(opt =>
                {
                    ...
                    opt.RegisterValidatorsFromAssemblyContaining(typeof(UserCreateEvent));
                });
            ...
            services.AddMiniSwagger(swaggerGenAction: opt =>
            {
                ...
                opt.AddDescriptions(typeof(DependencyInjection),
                    "XUCore.Template.Mediator.Applaction.xml",
                    "XUCore.Template.Mediator.Persistence.xml",
                    "XUCore.Template.Mediator.Core.xml");
