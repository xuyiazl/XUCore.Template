...
{
    public interface IWeChatUserService : ICurdService<long, WeChatUserEntity, WeChatUserDto, WeChatUserCreateCommand, WeChatUserUpdateInfoCommand, WeChatUserQueryCommand, WeChatUserQueryPagedCommand>, IScoped
    {
