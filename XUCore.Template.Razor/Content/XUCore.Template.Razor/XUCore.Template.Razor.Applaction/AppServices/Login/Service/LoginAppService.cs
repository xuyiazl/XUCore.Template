...
namespace XUCore.Template.Razor.Applaction.Login
{
    ...
    public class LoginAppService : ILoginAppService
    {
        ...
        public async Task<bool> LoginAsync(UserLoginCommand request, CancellationToken cancellationToken)
        {
            ...
            await user.LoginAsync(userDto.Id, userDto.UserName, userDto.Name, cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task<IList<PermissionMenuTreeDto>> GetPermissionMenusAsync(long userId, CancellationToken cancellationToken = default)
        {
