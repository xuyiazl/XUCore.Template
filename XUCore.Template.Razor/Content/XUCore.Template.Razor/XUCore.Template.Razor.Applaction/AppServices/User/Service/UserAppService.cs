...
namespace XUCore.Template.Razor.Applaction.User
{
    ...
    public class UserAppService : IUserAppService
    {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task<int> UpdateEnabledAsync(long[] ids, bool enabled, CancellationToken cancellationToken = default)
        {
            return await userService.UpdateAsync(ids, enabled, cancellationToken);
        }
        /// <summary>
        /// 删除账号（物理删除）
        /// </summary>
