...
$(function () {
    ...
    var columns = [
        ...
        {
            field: 'CompanyName', title: '公司名', sortable: true, align: 'left'
        },
        {
            field: 'Department', title: '所在部门', sortable: false, align: 'center'
        },
        {
            field: 'JobTitle', title: '所属职位', sortable: true, align: 'center'
        },
        {
            field: 'DateofEnrollment', title: '入职日期', sortable: true, align: 'center', formatter: function (val, row) {
        ...
        {
            field: 'DepartureDate', title: '离职日期', sortable: true, align: 'center', formatter: function (val, row) {
                var date = formatterTime(val, 'YYYY-MM');
    ...
    var contextMenuItem = function (row, $el) {
        ...
        switch (item) {
            case 'edit':
                window.parent.addTab({ id: 'resume-work-update-' + row.Id, href: '/admin/resume/workupdate/' + row.Id, icons: 'fa fa-plus-circle m-r-xs', text: '修改数据' + row.Id });
                break;
            case 'publish':
