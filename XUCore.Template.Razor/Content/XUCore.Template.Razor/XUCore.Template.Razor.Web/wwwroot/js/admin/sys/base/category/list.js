...
$(function () {
    ...
    var columns = [
        ...
        {
            field: 'Name', title: '类别名称', width: 150, sortable: false, align: 'center',
            editable: {
                type: 'text', title: '类别名称'
            }
        },
        {
            field: 'ParentName', title: '上级类别', width: 150, sortable: false, align: 'center'
        },
        ...
        {
            field: 'Css', title: '类别样式', width: 100, sortable: true, align: 'center',
            editable: {
                type: 'text', title: '类别样式'
            }
        },
        {
    ...
    var contextMenuItem = function (row, $el) {
        ...
        switch (item) {
            case 'edit':
                window.parent.addTab({ id: 'base-category-update-' + row.Id, href: '/admin/sys/base/category/update/' + row.Id, icons: 'fa fa-plus-circle m-r-xs', text: '修改类别' + row.Id });
                break;
            case 'publish':
