...
$(function () {
    ...
    var columns = [
        ...
        {
            field: 'PerPinYin', title: '首字母', sortable: true, align: 'center'
        },
        {
            field: 'Name', title: '地区', sortable: false, align: 'left'
        },
        {
            field: 'WholeName', title: '全名', sortable: false, align: 'left'
        },
        {
            field: 'Level', title: '等级', sortable: true, align: 'center'
        },
        {
            field: 'CityCode', title: '电话区号', sortable: false, align: 'center'
        },
        {
            field: 'ZipCode', title: '邮政编码', sortable: false, align: 'center'
        },
        {
            field: 'AreaCode', title: '行政代码', sortable: false, align: 'center'
        },
        {
    ...
    var contextMenuItem = function (row, $el) {
        ...
        switch (item) {
            case 'edit':
                window.parent.addTab({ id: 'admin-chinaarea-update-' + row.Id, href: '/admin/sys/admin/chinaarea/update/' + row.Id, icons: 'fa fa-plus-circle m-r-xs', text: '修改地区' + row.Id });
                break;
            case 'publish':
