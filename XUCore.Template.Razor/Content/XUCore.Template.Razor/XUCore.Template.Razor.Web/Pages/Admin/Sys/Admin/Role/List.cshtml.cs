...
namespace Nigel.Web.Pages.Admin.Sys.Admin.Role
{
    ...
    public class ListModel : PageModel
    {
        ...
        {
            var paged = await adminUserAppService.GetRolePagedAsync(new AdminRoleQueryPaged
            {
        ...
        {
            var res = await adminUserAppService.UpdateRoleAsync(id, field, value);
        ...
        public async Task<IActionResult> OnPutBatchStatusAsync([FromForm] long[] ids, [FromForm] Status status)
        {
            ...
            var res = await adminUserAppService.UpdateRoleAsync(status, ids);
        ...
        public async Task<IActionResult> OnDeleteBatchDeleteAsync([FromForm] long[] ids)
        {
            ...
            var res = await adminUserAppService.DeleteRoleAsync(ids);
