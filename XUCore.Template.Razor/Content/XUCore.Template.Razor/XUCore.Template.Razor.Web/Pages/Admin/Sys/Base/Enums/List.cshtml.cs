...
{
    [Authorize]
    [AccessControl(AccessKey = "base-enum-list")]
    public class ListModel : PageModel
    {
        ...
        public void OnGet()
        {
            CodeList = basicsAppService.GetEnumDistinctByCode();
        }
        ...
        {
            var paged = await basicsAppService.GetEnumPagedAsync(new EnumQueryPaged
            {
        ...
        {
            var res = await basicsAppService.UpdateEnumAsync(id, field, value);
        ...
        {
            var res = await basicsAppService.UpdateEnumAsync(status, ids);
        ...
        {
            var res = await basicsAppService.DeleteEnumAsync(ids);
