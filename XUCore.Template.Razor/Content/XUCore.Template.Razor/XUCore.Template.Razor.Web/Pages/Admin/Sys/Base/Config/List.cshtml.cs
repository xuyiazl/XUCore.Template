...
{
    [Authorize]
    [AccessControl(AccessKey = "base-config-list")]
    public class ListModel : PageModel
    {
        ...
        public void OnGet()
        {
            CodeList = basicsAppService.GetConfigDistinctByCode();
        }
        ...
        {
            var paged = await basicsAppService.GetConfigPagedAsync(new ConfigQueryPaged
            {
        ...
        {
            var res = await basicsAppService.UpdateConfigAsync(id, field, value);
        ...
        {
            var res = await basicsAppService.UpdateConfigAsync(status, ids);
        ...
        {
            var res = await basicsAppService.DeleteConfigAsync(ids);
