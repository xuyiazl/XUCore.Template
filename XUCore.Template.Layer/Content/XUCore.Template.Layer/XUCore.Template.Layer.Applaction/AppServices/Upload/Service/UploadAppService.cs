...
namespace XUCore.Template.Layer.Applaction.Upload
{
    /// <summary>
    /// 文件上传
    /// </summary>
    public class UploadAppService : IUploadAppService
    {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task<Result<ImageFileInfo>> UploadImage(Base64Command command, CancellationToken cancellationToken)
        {
